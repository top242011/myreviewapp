...
export default function RootLayout({
  ...
  return (
    <html lang="th">
      {/* Applying background gradient and base text color directly to the body. */}
      {/* This ensures the background and default text are handled by Tailwind's core processing. */}
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased
        bg-gradient-to-br from-purple-700 to-indigo-800 bg-fixed min-h-screen text-gray-100 overflow-x-hidden font-sans`}>
        {children}
      </body>
    </html>
  );
